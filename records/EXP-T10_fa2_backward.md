...
- **为什么 backward 的 TFLOPS(83.1)低于 forward(123)**:backward 每 FLOP 要配套读更多数据(重算要再读一遍 Q/K/V/dO),算术强度低于 forward,更接近带宽侧 —— 这正是 recomputation 的代价,不是缺陷。(数值经 2026-09-16 勘误:原写 66.5,系 FLOPs 口径用了不重算的 8·S²·D。)
